...
cleaned_mod1_OD_upto1YR <- butcher::axe_fitted(mod_OD_upto1YR, verbose = TRUE)
butcher::weigh(cleaned_mod1_OD_upto1YR)
lobstr::obj_size(cleaned_mod1_OD_upto1YR)

cleaned_mod1_OD_upto1YR$spec

cleaned_mod1_OD_upto1YR%>% predict(signl, type="prob")%>%select(.pred_1)%>% round(.,4)*100
...
cleaned_mod1_OD_upto5YR <- butcher::axe_fitted(mod_OD_upto5YR, verbose = TRUE)
butcher::weigh(cleaned_mod1_OD_upto5YR)
lobstr::obj_size(cleaned_mod1_OD_upto5YR)

cleaned_mod1_OD_upto5YR$spec

cleaned_mod1_OD_upto5YR%>% predict(signl, type="prob")%>%select(.pred_1)%>% round(.,4)*100
...
cleaned_mod1_OD_upto10YR <- butcher::axe_fitted(mod_OD_upto10YR, verbose = TRUE)
butcher::weigh(cleaned_mod1_OD_upto10YR)
lobstr::obj_size(cleaned_mod1_OD_upto10YR)

cleaned_mod1_OD_upto10YR$spec

cleaned_mod1_OD_upto10YR%>% predict(signl, type="prob")%>%select(.pred_1)%>% round(.,4)*100
###################################Model_HU_1YR###################################
out="HU_1YR"
df=Data_merged%>%
  select(c(out,preds))
...
cleaned_mod1_HU_1YR <- butcher::axe_fitted(mod_HU_1YR, verbose = TRUE)
butcher::weigh(cleaned_mod1_HU_1YR)
lobstr::obj_size(cleaned_mod1_HU_1YR)

cleaned_mod1_HU_1YR$spec

cleaned_mod1_HU_1YR%>% predict(signl, type="prob")%>%select(.pred_1)%>% round(.,4)*100
...
cleaned_mod1_HU_5YR <- butcher::axe_fitted(mod_HU_5YR, verbose = TRUE)
butcher::weigh(cleaned_mod1_HU_5YR)
lobstr::obj_size(cleaned_mod1_HU_5YR)

cleaned_mod1_HU_5YR$spec

cleaned_mod1_HU_5YR%>% predict(signl, type="prob")%>%select(.pred_1)%>% round(.,4)*100
...
cleaned_mod1_HU_10YR <- butcher::axe_fitted(mod_HU_10YR, verbose = TRUE)
butcher::weigh(cleaned_mod1_HU_10YR)
lobstr::obj_size(cleaned_mod1_HU_10YR)

cleaned_mod1_HU_10YR$spec

cleaned_mod1_HU_10YR%>% predict(signl, type="prob")%>%select(.pred_1)%>% round(.,4)*100
...
cleaned_mod1_STA_1YR <- butcher::axe_fitted(mod_STA_1YR, verbose = TRUE)
butcher::weigh(cleaned_mod1_STA_1YR)
lobstr::obj_size(cleaned_mod1_STA_1YR)

cleaned_mod1_STA_1YR$spec

cleaned_mod1_STA_1YR%>% predict(signl, type="prob")%>%select(.pred_1)%>% round(.,4)*100
...
cleaned_mod1_STA_5YR <- butcher::axe_fitted(mod_STA_5YR, verbose = TRUE)
butcher::weigh(cleaned_mod1_STA_5YR)
lobstr::obj_size(cleaned_mod1_STA_5YR)

cleaned_mod1_STA_5YR$spec

cleaned_mod1_STA_5YR%>% predict(signl, type="prob")%>%select(.pred_1)%>% round(.,4)*100
...
cleaned_mod1_STA_10YR <- butcher::axe_fitted(mod_STA_10YR, verbose = TRUE)
butcher::weigh(cleaned_mod1_STA_10YR)
lobstr::obj_size(cleaned_mod1_STA_10YR)

cleaned_mod1_STA_10YR$spec

cleaned_mod1_STA_10YR%>% predict(signl, type="prob")%>%select(.pred_1)%>% round(.,4)*100
###################################Model_MTA_5YR###################################
out="MTA_5YR"
df=Data_merged%>%
  select(c(out,preds))
...
cleaned_mod1_MTA_5YR <- butcher::axe_fitted(mod_MTA_5YR, verbose = TRUE)
butcher::weigh(cleaned_mod1_MTA_5YR)
lobstr::obj_size(cleaned_mod1_MTA_5YR)

cleaned_mod1_MTA_5YR$spec

cleaned_mod1_MTA_5YR%>% predict(signl, type="prob")%>%select(.pred_1)%>% round(.,4)*100
...
cleaned_mod1_MTA_10YR <- butcher::axe_fitted(mod_MTA_10YR, verbose = TRUE)
butcher::weigh(cleaned_mod1_MTA_10YR)
lobstr::obj_size(cleaned_mod1_MTA_10YR)

cleaned_mod1_MTA_10YR$spec

cleaned_mod1_MTA_10YR%>% predict(signl, type="prob")%>%select(.pred_1)%>% round(.,4)*100
...
cleaned_mod1_LTA_10yr <- butcher::axe_fitted(mod_LTA_10yr, verbose = TRUE)
butcher::weigh(cleaned_mod1_LTA_10yr)
lobstr::obj_size(cleaned_mod1_LTA_10yr)

cleaned_mod1_LTA_10yr$spec

cleaned_mod1_LTA_10yr%>% predict(signl, type="prob")%>%select(.pred_1)%>% round(.,4)*100
...
save.image("~/OneDrive - Universite de Montreal/Usydney/shiny_LR_data.RData")
l#oad("~/Usydney/Atos/shinymodels.RData")
